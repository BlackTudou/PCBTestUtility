...
namespace Microstar.Production.Tools
{
    ...
    {
        private static readonly int maxSize = 50 * 1024 * 1024;
        ...
        public static uint GetFileCRC32(string pathName)
        {
            ...
            if (fileInfo.Length >= maxSize) //最大50M
            {
                return 0;
            }

            var bin = File.ReadAllBytes(pathName);
            uint crc = 0xFFFFFFFF;
