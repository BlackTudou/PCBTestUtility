...
{ 
    public class INIOperationClass
    {
        ...
        */
        ...
        //private static extern uint GetPrivateProfileString(string lpAppName, string lpKeyName, string lpDefault, [MarshalAs(UnmanagedType.LPArray)] byte[] lpReturnedString, uint nSize, string lpFileName);
        ...
        public static string INIGetStringValue(string iniFile, string section, string key, string defaultValue)
        {
            ...
            //StringBuilder sb = new StringBuilder(SIZE);
            uint bytesReturned = INIOperationClass.GetPrivateProfileString(section, key, defaultValue, buff, SIZE, iniFile);
